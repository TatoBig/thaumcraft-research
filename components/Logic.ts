const Logic = {
    'aer': {
      made: undefined,
      make: ['lux', 'motus', 'tempestas', 'vacuos', 'volatus', 'arbor', 'auram', 'sensus', ]
    },
    'alienis': {
    ...
    'auram': {
      ...
      'ordo': {
        made: undefined,
        make: ['gelum', 'mortuus', 'permutatio', 'tenebrae', 'vacuos', 'venenum', 'vinculum', 'vitium'],
      },
      'pannus': {
      ...
      'terra': {
        made: undefined,
        make: ['herba', 'iter', 'metallum', 'perfodio', 'tutamen', 'victus', 'vitreus'],
      },
      'tutamen': {
      ...
      'vacuos': {
        made: ['aer', 'perditio'],
        make: ['alienis', 'fames' , 'praecantatio', 'tenebrae'],
      },
      'venenum': {
        made: ['aqua', 'perditio'],
        make: undefined,
